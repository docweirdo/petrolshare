...
class OpenContainerPushFuture extends StatefulWidget {
  ...
  @override
  _OpenContainerPushFutureState createState() => _OpenContainerPushFutureState();
}

class _OpenContainerPushFutureState extends State<OpenContainerPushFuture> {
  ...
  Future<T> openContainer<T extends Object>() async {
    T ret = await Navigator.of(context, rootNavigator: widget.useRootNavigator)
